...
config :locacao_api, LocacaoApiWeb.Endpoint,
  ...
  render_errors: [
    formats: [json: LocacaoApiWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: LocacaoApi.PubSub,
  live_view: [signing_salt: "byPWKGnb"]
...
config :locacao_api, LocacaoApi.Mailer, adapter: Swoosh.Adapters.Local
